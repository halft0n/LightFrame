          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {memories.map((memory) => (
              <button
                ...
                className="group flex flex-col overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900/50 text-left transition hover:border-neutral-600 hover:bg-neutral-800/80"
              >
