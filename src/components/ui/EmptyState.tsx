    ...
    return (
      <div className="empty-state-icon" aria-hidden="true">
        <svg viewBox="0 0 120 120" className="h-28 w-28" fill="none">
          ...
          />
          <path
            d="M28 72 L48 58 L62 68 L82 50 L92 58 L92 86 L28 86 Z"
            fill="var(--accent-primary)"
            opacity="0.25"
          />
          <circle
  ...
  return (
    <div className="empty-state-icon" aria-hidden="true">
      <svg viewBox="0 0 120 120" className="h-24 w-24" fill="none">
        ...
        />
        <path
          d="M24 72 L44 56 L58 66 L78 46 L96 60 L96 88 L24 88 Z"
          fill="var(--accent-primary)"
          opacity="0.2"
        />
        <circle
