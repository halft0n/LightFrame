...
| 版本 | 范围 | 说明 | 状态 |
|------|------|------|------|
| v0.0.18 | Phase 0–4 安全/架构改进 | 代码审查修复、commands 拆分、安全加固 | ✅ 完成 |
| v0.0.19 | Phase 5 全部 | 5a–5d 功能对齐（Live Photo/编辑器/交互/平台） | ✅ 当前 |
| v0.1.0-beta | Phase 6 完成 | 签名/公证、10万+压测、P0 bug 清零 | ⬜ 目标 |
